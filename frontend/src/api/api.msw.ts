...
export const getListPostsMockHandler = (overrideResponse?: SchemaPostResponse[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => SchemaPostResponse[])) => {
...
export const getCreatePostMockHandler = (overrideResponse?: SchemaPostResponse[] | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => SchemaPostResponse[])) => {
...
export const getSignInMockHandler = (overrideResponse?: SchemaUserResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => SchemaUserResponse)) => {
...
export const getGetCurrentUserMockHandler = (overrideResponse?: SchemaUserResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => SchemaUserResponse)) => {
...
export const getGetPostMockHandler = (overrideResponse?: SchemaPostResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => SchemaPostResponse)) => {
...
export const getListPostCommentsMockHandler = (overrideResponse?: SchemaCommentResponse[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => SchemaCommentResponse[])) => {
...
export const getCreatePostCommentsMockHandler = (overrideResponse?: SchemaMutationSchema | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => SchemaMutationSchema)) => {
...
export const getDeletePostCommentsMockHandler = (overrideResponse?: SchemaMutationSchema | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => SchemaMutationSchema)) => {
...
export const getPutPostCommentsMockHandler = (overrideResponse?: SchemaMutationSchema | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => SchemaMutationSchema)) => {
...
export const getDeletePostMockHandler = (overrideResponse?: SchemaMutationSchema | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => SchemaMutationSchema)) => {
...
export const getUpdatePostMockHandler = (overrideResponse?: SchemaMutationSchema | ((info: Parameters<Parameters<typeof http.put>[1]>[0]) => SchemaMutationSchema)) => {
