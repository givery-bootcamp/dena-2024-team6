...
export const getListPostsResponseMock = (): SchemaPostResponse[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({post_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), title: faker.helpers.arrayElement([faker.word.sample(), undefined]), user_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])})))

export const getCreatePostResponseMock = (): SchemaPostResponse[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({post_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), title: faker.helpers.arrayElement([faker.word.sample(), undefined]), user_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])})))
...
export const getGetPostResponseMock = (overrideResponse: Partial< SchemaPostDetailResponse > = {}): SchemaPostDetailResponse => ({body: faker.helpers.arrayElement([faker.word.sample(), undefined]), created_at: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`, undefined]), post_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), title: faker.helpers.arrayElement([faker.word.sample(), undefined]), updated_at: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`, undefined]), user_id: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), user_name: faker.helpers.arrayElement([faker.word.sample(), undefined]), ...overrideResponse})
...
export const getGetPostMockHandler = (overrideResponse?: SchemaPostDetailResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<SchemaPostDetailResponse> | SchemaPostDetailResponse)) => {
